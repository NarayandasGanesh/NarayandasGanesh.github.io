  ...
  return (
    <div>
      <h1 id="project" className="heading">
        <span className="heading-highlight">Projects</span> Section
      </h1>
      ...
      repudiandae dolores maxime minus. Lorem ipsum dolor, sit amet consectetur
      adipisicing elit. Atque accusantium minus debitis beatae ducimus quam
